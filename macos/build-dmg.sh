...
hdiutil makehybrid -hfs -hfs-volume-name "DiskSift" -o "$BUILD_ROOT/DiskSift-uncompressed" "$STAGE"
hdiutil convert "$BUILD_ROOT/DiskSift-uncompressed.dmg" -format UDZO -o "$BUILD_ROOT/DiskSift.dmg"
