...
export default async function BuildInPublicPage() {
  ...
  const metrics = [
    [freeDownloads.toLocaleString(), "Free download-link clicks"],
    [licenses.toLocaleString(), "Active Pro licenses"],
    [proDownloads.toLocaleString(), "Pro download-link clicks"],
