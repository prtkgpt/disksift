...
export default function PrivacyPage() {
  return <LegalLayout title="Privacy Policy" updated="September 7, 2026">
    ...
    <section><h2>2. Information we process</h2><p>When you purchase or activate Pro, we may process your email address, Stripe customer and transaction identifiers, license status, license-key hash, anonymous activation identifier, device name, and activation timestamps. We do not receive your full payment-card number. Our website uses Google Analytics to process page visits, interactions, browser and device information, and approximate location derived from network information. Google Analytics is not loaded on purchase-completion or blog-administration pages.</p></section>
    ...
    <section><h2>4. Service providers</h2><p>Our website may use Vercel for hosting, Stripe for payments, Resend for transactional email, Neon for license and purchase records, and Google Analytics for aggregate website measurement. Those providers process information under their respective policies. Standard server logs may include IP address, browser information, requested URL, and request time for security and reliability.</p></section>
    <section><h2>5. Cookies and analytics</h2><p>DiskSift does not use advertising cookies or sell personal information. Google Analytics may use analytics storage to measure website usage. Essential cookies may be used where necessary for security or an administration session. Payment information is handled by Stripe under its own privacy terms.</p></section>
