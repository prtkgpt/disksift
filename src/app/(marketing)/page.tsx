...
export default function MarketingPage() {
  ...
  return <main>
    <nav className="nav shell"><a className="brand" href="#top"><span className="brand-mark"><SparkIcon /></span>DiskSift</a><div className="nav-links"><a href="#features">Features</a><a href="#how">How it works</a><a href="#pricing">Pricing</a><a href="/build-in-public">Build in public</a><a href="/blog">Blog</a></div><a className="nav-cta" href="/api/download?edition=free&source=nav">Download for Mac <span>↓</span></a></nav>
    ...
    <section className="features-section shell" id="features"><div className="features-heading"><div><div className="section-kicker">FEATURES</div><h2>See it. Understand it.<br/>Clear it safely.</h2></div><div><p>DiskSift focuses on the decisions that free meaningful space without turning cleanup into guesswork.</p><a href="#pricing">Compare Free and Pro →</a></div></div><div className="feature-showcase">
      {[
        ...
        ["06","Developer-junk discovery","Find bulky dependency folders, Derived Data, caches, and simulator files with safety guidance.","PRO"]
