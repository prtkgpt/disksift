...
export default function RefundPolicyPage() {
  return <LegalLayout title="Refund Policy" updated="September 2, 2026">
    ...
    <section><h2>Requesting a refund</h2><p>Email <a href="mailto:hello@disksift.com">hello@disksift.com</a> from the address used at checkout. Include your Stripe receipt or order identifier if available. A reason is optional, although feedback helps us improve.</p></section>
